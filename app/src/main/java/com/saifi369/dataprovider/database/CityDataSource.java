package com.saifi369.dataprovider.database;
...
public class CityDataSource {
    ...
    public void seedDatabase(){
        ...
        //this code is for transaction demo
        // if used, will not insert data into database
...
//                    try {
//                        if (item.getCityName().equals("Lahore")){
//                            throw new Exception("lahore k apny e mazy hain ....");
//                        }
//                        insertItem(item);
